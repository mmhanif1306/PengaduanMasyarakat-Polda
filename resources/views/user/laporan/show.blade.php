                        ...
                        <div class="py-6 border-t border-gray-200">
                            ...
                            <div class="mt-4">
                                @if (Str::endsWith($laporan->bukti, ['.jpg', '.jpeg', '.png', '.gif']))
                                    <img src="{{ Storage::url($laporan->bukti) }}" alt="Bukti laporan"
                                            ...
                                            <div class="relative pb-8">
                                                ...
                                                {{ $notifikasi->status === 'ditolak' ? 'bg-red-500' : '' }}">
                                                    ...
                                                    <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                                                        <div>
                                                            <p class="text-sm text-gray-500">Status diubah menjadi <span
                                                                    class="font-medium text-gray-900">{{ ucfirst($notifikasi->status) }}</span>
                                                            </p>
