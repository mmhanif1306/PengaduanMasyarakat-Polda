                            ...
                            @if (auth()->user()->role === 'admin')
                                <a href="{{ route('admin.dashboard') }}"
                                    ...
                                    @if(request()->routeIs('admin.dashboard'))
                                        <div class="absolute inset-0 rounded-lg bg-gradient-to-r from-white/10 to-white/20 opacity-100"></div>
                                    @else
                        ...
                        <div class="relative">
                            ...
                            <div class="hidden origin-top-right absolute right-0 mt-3 w-56 rounded-xl shadow-xl py-2 bg-white backdrop-blur-md ring-1 ring-black/5 border border-white/20 z-50 transform opacity-0 scale-95 transition-all duration-200 ease-out"
                                ...
                                <a href="{{ route('profile') }}"
                                    ...
                                    <svg class="w-4 h-4 mr-3 text-gray-400 group-hover:text-primary-500" fill="currentColor"
                                        viewBox="0 0 20 20">
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        <svg class="w-4 h-4 mr-3 text-gray-400 group-hover:text-red-500" fill="currentColor"
                                            viewBox="0 0 20 20">
                                            <path fill-rule="evenodd"
