                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="status" name="status"
                                            class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm pl-4 pr-10 py-3 bg-white transition-all duration-200 hover:border-primary-300">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" name="date" id="date"
                                            class="block w-full rounded-xl border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm pl-4 pr-4 py-3 transition-all duration-200 hover:border-primary-300">
                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                                    <tr>
                                        <th scope="col"
                                            class="py-4 pl-6 pr-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($laporan as $item)
                                        <tr class="hover:bg-gray-50 transition-colors duration-200">
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                                                <div class="flex items-center">
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-primary-600 font-semibold text-xs">{{ $loop->iteration }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="px-6 py-4 text-sm text-gray-900">
                                                <div class="max-w-xs">
                                                    <div class="font-medium text-gray-900 truncate">{{ $item->judul }}
                                                    </div>
                                            ...
                                            <td class="px-15 py-4 text-sm text-gray-900">
                                                <div class="flex items-start">
                                                    ...
                                                    <div class="max-w-3xs break-words">
                                                        <span>{{ $item->alamat }}</span><br>
                                                        <span class="text-gray-500 text-xs">{{ $item->kelurahan }},
                                                            {{ $item->kecamatan }}</span><br>
                                                        <span class="text-gray-500 text-xs">{{ $item->kota }},
                                                            {{ $item->provinsi }}</span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="{{ route('admin.laporan.show', $item->id) }}"
                                                    class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-lg text-primary-600 bg-primary-50 hover:bg-primary-100 hover:text-primary-700 transition-all duration-200">
                    ...
                    <div
                        ...
                        <div class="flex flex-1 justify-between sm:hidden">
                            @if ($laporan->onFirstPage())
                                <span
                                    class="relative inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500">Previous</span>
                            @else
                            ...
                            @else
                                <span
                                    class="relative ml-3 inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-500">Next</span>
                            @endif
                        </div>
