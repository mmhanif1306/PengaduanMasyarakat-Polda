...
@section('content')
    <div
        class="min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 mb-16 bg-gradient-to-br from-gray-50 via-white to-gray-100">
        <div class="pt-5 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-3 text-center text-sm text-gray-600">
                Sudah memiliki akun?
                <a href="/login"
                    class="font-semibold text-primary-600 hover:text-primary-500 transition-colors duration-200">
                    Masuk di sini
                </a>
            </p>
        </div>
                ...
                <form class="space-y-6" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd"></path>
                                    <path d="M6 8h8v2H6V8zM6 12h4v2H6v-2z"></path>
                                </svg>
                            </div>
                            <input id="nik" name="nik" type="text" autocomplete="off" required
                                placeholder="Masukkan 16 digit NIK Anda" maxlength="16" pattern="[0-9]{16}"
                                class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200 bg-gray-50 focus:bg-white"
                                value="{{ old('nik') }}">
                        </div>
                        @error('nik')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="no_telp" name="no_telp" type="tel" autocomplete="tel" required
                    ...
                    <div class="pt-4">
                        <button type="submit"
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <svg class="h-5 w-5 text-primary-300 group-hover:text-primary-200 transition-colors duration-200"
