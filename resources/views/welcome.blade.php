...
@section('content')
    ...
    <div class="relative min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div
                class="absolute top-20 right-20 w-16 h-16 bg-gradient-to-br from-primary-200 to-primary-300 rounded-full opacity-30 animate-pulse">
            </div>
            <div
                class="absolute bottom-32 right-32 w-12 h-12 bg-gradient-to-br from-secondary-200 to-secondary-300 rounded-full opacity-40 animate-bounce">
            </div>
            <div
                class="absolute top-1/3 right-1/4 w-8 h-8 bg-gradient-to-br from-green-200 to-green-300 rounded-full opacity-50 animate-ping">
            </div>
            ...
            <div class="absolute top-1/4 left-1/4 animate-float">
                <svg class="w-8 h-8 text-primary-300 opacity-60" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <path fill-rule="evenodd"
                        d="M4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zM6 5v6h8V5H6z"
                        clip-rule="evenodd"></path>
                </svg>
            </div>
            <div class="absolute top-2/3 right-1/3 animate-float" style="animation-delay: 1s;">
                <svg class="w-6 h-6 text-secondary-300 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd"
                        d="M18 8a6 6 0 01-7.743 5.743L10 14l-4 1-1-4 .257-.257A6 6 0 1118 8zm-6-4a1 1 0 100-2 1 1 0 000 2z"
                        clip-rule="evenodd"></path>
                </svg>
            </div>
        ...
        <div class="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="mb-8 animate-fade-in">
                    ...
                    <h1
                        class="text-4xl md:text-6xl font-bold bg-gradient-to-r from-primary-600 to-primary-800 bg-clip-text text-transparent mb-4 leading-tight py-2">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-down">
                    @guest
                        <a href="/register"
                            class="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-primary-600 to-primary-700 rounded-xl hover:from-primary-700 hover:to-primary-800 transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl">
                            <span class="mr-2">Mulai Pengaduan</span>
                            <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform duration-200" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                        ...
                        <a href="/login"
                            class="group inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-primary-700 bg-white border-2 border-primary-200 rounded-xl hover:bg-primary-50 hover:border-primary-300 transition-all duration-200 shadow-lg hover:shadow-xl">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="scroll-animate" data-animation="fade-up" data-delay="100">
                    <div
                        class="group p-8 bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                        ...
                        <p class="text-gray-600">Data pengaduan Anda dijamin aman dengan sistem keamanan berlapis dan
                ...
                <div class="scroll-animate" data-animation="fade-up" data-delay="200">
                    <div
                        class="group p-8 bg-gradient-to-br from-secondary-50 to-secondary-100 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
                        ...
                        <p class="text-gray-600">Pengaduan Anda akan diproses dengan cepat dan mendapat tanggapan dalam
                            waktu yang wajar.</p>
                    </div>
                </div>
                ...
                <div class="scroll-animate" data-animation="fade-up" data-delay="300">
                    <div
                        class="group p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-2xl hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                            <svg class="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 mb-4">Transparan</h3>
                        <p class="text-gray-600">Pantau status pengaduan Anda secara real-time dengan sistem tracking yang
                            transparan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div class="text-center scroll-animate" data-animation="fade-up" data-delay="100">
                    <div class="relative mb-4">
                        <svg class="w-12 h-12 text-white mx-auto mb-2 opacity-80" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="relative text-center scroll-animate" data-animation="fade-up" data-delay="100">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <span class="text-2xl font-bold text-white">1</span>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Daftar & Masuk</h3>
                    <p class="text-gray-600">Buat akun baru atau masuk dengan akun yang sudah ada untuk mulai menggunakan
                        platform.</p>
                    <!-- Arrow -->
                ...
                <div class="relative text-center scroll-animate" data-animation="fade-up" data-delay="200">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-secondary-500 to-secondary-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                        <span class="text-2xl font-bold text-white">2</span>
                    </div>
                    <h3 class="text-xl font-semibold text-gray-900 mb-4">Buat Pengaduan</h3>
                    <p class="text-gray-600">Isi formulir pengaduan dengan detail yang jelas dan lengkap beserta bukti
                        pendukung.</p>
                    <!-- Arrow -->
                ...
                <div class="text-center scroll-animate" data-animation="fade-up" data-delay="300">
                    ...
                    <p class="text-gray-600">Pantau perkembangan pengaduan Anda dan terima notifikasi update secara
                        real-time.</p>
                </div>
            </div>
        </div>
